...
public class LiquidProgressUI extends BasicProgressBarUI{
    ...
    @Override
    public void paint (Graphics graph, JComponent jc){
        ...
        if (progressBar.isStringPainted()) { // print oercentage.
            paintString(graph);
        }
        g2.dispose();
    ...
    private void createAnimation(Graphics2D graph, int x, int y, int size) {
